...
const VideoPlayer = ({ store }) => {
  ...
  return (
    <article className="videoPlayerInfo">
      ...
      <p>
        Welkom bij <strong className="strong">D4E1</strong>: Design for
        Everyone!
        <br />
        D4E1 is het videoplatform waar deze community samen producten
        ontwikkelen die de levenskwaliteit verbeteren van mensen met een
        beperking. <br />
